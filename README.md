...
- 🧠 **AI Products** — [vital](https://github.com/ximing/vital) (a calm personal OS: inbox → todos → reports, with an agent-ready API & Claude skill) · [moment](https://github.com/ximing/moment) (shareable family timeline chains — moments, milestones & AI monthly recaps) · [aimo](https://github.com/ximing/aimo) (AI-driven knowledge management) · **vane** (Rust-core hybrid vector + BM25 retrieval engine, embeddable in Node / Go / browsers) · **aipet** (an LLM desktop companion that remembers you)
